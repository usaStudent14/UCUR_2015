...
public:
	...
	//HEY CUSTOM EDIT OVER HERE
	//Overloading the assignment operator
	QueueArray<T>& operator=(QueueArray<T> o);
...
// set the printer of queue to point nowhere.
...
template<typename T>
QueueArray<T>& QueueArray<T>::operator=(QueueArray<T> o) {
